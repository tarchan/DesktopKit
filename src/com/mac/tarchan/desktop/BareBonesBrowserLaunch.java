...
public class BareBonesBrowserLaunch
{
	...
	public static void browse(String url) throws ClassNotFoundException, IllegalAccessException, IllegalArgumentException, InterruptedException,
			InvocationTargetException, IOException, NoSuchMethodException
	{
		...
		{ // assume Unix or Linux
			...
			if (browser == null) throw new NoSuchMethodException("Could not find web browser");
